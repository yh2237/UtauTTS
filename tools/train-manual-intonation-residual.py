...
def main() -> int:
    ...
    model_json = {
        ...
        "license": base_model.get("license", "Academic research, non-commercial research, and personal use only; commercial use requires permission from the JSUT rights holders"),
