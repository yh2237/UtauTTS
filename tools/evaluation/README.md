...
`english-coda-coverage-v1.json`は破裂音・摩擦音・鼻音・子音群と短文の16ケースです。`--phonemizer en-delta`または`en-vccv`で音源に合わせます。次の原音が必須語末子音の再生時間を10 ms未満まで削る場合は重なりを抑えます。この調整はCPU版WORLDに限定しています。音源に含まれない音: 生成対象外。音源や文章による聞き取りやすさ: 個別評価。
